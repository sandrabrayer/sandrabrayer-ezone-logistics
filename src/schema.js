...
export const HEADERS = {
  ...
  // Budgets (budget module) — one row per house per month. Olga fills rows directly in the Sheet (see the
  // in-app help page, section "תקציב חודשי"); setupSheet() ensures these headers exist on the live tab.
